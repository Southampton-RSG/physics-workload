...
CSRF_TRUSTED_ORIGINS: List[str] = [
    ...
    "http://teaching.physics.soton.ac.ukhttp://srv04619.soton.ac.uk",
]
...
STATICFILES_DIRS: Tuple[Path] = (BASE_DIR / "app" / "static",)
...
def skip_static_records(record: LogRecord) -> bool:
    ...
    :return:
    """
    return hasattr(record, "message") and "GET /static/" not in record.message
